let modInfo = {
	name: "反物质魔塔树",
	nameEN: "",// When you open the otherLanguageMod, this is the second language
	id: "mymod2",
	author: "22222",
	pointsName: "反物质",
...
function changelog(){
	return (options.ch || modInfo.languageMod==false)?`
		<br><br><br><h1>写更新日志:</h1><br>(不存在<span style='color: red'><s>剧透警告</s></span>)<br><br>
...
function displayThingsRes(){
	return '反物质: '+format(player.points)+' 维度提升:3 '+' <br>血量:8302 '+' 攻击:68 '+' 防御:53 '+' <br>黄钥匙:0 '+' 蓝钥匙:0 '+' 红钥匙:0 '+' <br>绿钥匙:999 '
}
